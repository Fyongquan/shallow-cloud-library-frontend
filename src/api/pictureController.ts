...
/** createPictureShare POST /api/picture/share */
export async function createPictureShareUsingPost(
  body: API.PictureShareRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePictureShareVO_>('/api/picture/share', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
